...
import strategyAdvisory from "../../assets/family-advisory-office.jpg";
import strategyVirtual from "../../assets/family-virtual-office.jpg";

const strategyImages = [strategySingle, strategyShared, strategyAdvisory, strategyVirtual];

const FamilyOffice = () => {
  const { t } = useTranslation();
  const base = "servicePages.familyOffice";
