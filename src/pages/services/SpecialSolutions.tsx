...
const strategyImages = [strategyRealEstate, strategyArt, strategyPhilanthropy, strategyEsg];

const SpecialSolutions = () => {
  const { t } = useTranslation();
  const base = "servicePages.specialSolutions";
